...
ALTER TABLE batch_enrollment DROP INDEX uc_batch_enrollments_student;

ALTER TABLE teacher_batch DROP INDEX uc_teacher_batch_teacher;

ALTER TABLE student_institutes DROP INDEX uc_student_institutes_student ;

ALTER TABLE teacher_institutes DROP INDEX uc_teacher_institutes_teacher;
