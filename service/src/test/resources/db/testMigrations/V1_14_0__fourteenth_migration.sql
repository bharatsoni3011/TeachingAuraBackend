...
ALTER TABLE batch_test_submission_test_attachment
    ADD CONSTRAINT fk_btsta_on_batch_submission FOREIGN KEY (batch_test_submission_id) REFERENCES submission (id);

ALTER TABLE batch_test_submission_test_attachment
    ADD CONSTRAINT fk_btsta_on_test_attachment FOREIGN KEY (testAttachments_id) REFERENCES test_attachment (id);
